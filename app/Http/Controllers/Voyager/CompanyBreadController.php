...
*/
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->has('_validate')) {
            ...
            $resposta_admin = DB::insert('insert into users (role_id, name, email, password, created_at ) values (?, ?, ?, ?, ?)', [
                6, //Admin empresa
            ...
            $resposta_magatzem = DB::insert('insert into users (role_id, name, email, password, created_at ) values (?, ?, ?, ?, ?)', [
                5, //Magatzem empresa
